      ...
      <div className="login-page-wrapper w-full py-10">
        <div className="container-x mx-auto">
          <div className="lg:flex items-center relative">
            {myUser ? <div className="lg:w-[572px] w-full h-[783px] bg-white flex flex-col justify-center sm:p-10 p-5 border border-[#E0E0E0]">
              <div className="w-full">
                <div className="title-area flex flex-col justify-center items-center relative text-center mb-7">
                  {myUser ? <h1 className="text-[34px] font-bold leading-[74px] text-qblack">
                    Logged In
                  </h1> : <h1 className="text-[34px] font-bold leading-[74px] text-qblack">Log In</h1>}
                ...
                <div className="input-area">
                  ...
                  <div className="signin-area mb-3.5 cursor-pointer">
            ...
            </div> : <div className="lg:w-[572px] w-full h-[783px] bg-white flex flex-col justify-center sm:p-10 p-5 border border-[#E0E0E0]">
              <div className="w-full">
                <div className="title-area flex flex-col justify-center items-center relative text-center mb-7">
                ...
                <div className="input-area">
                  ...
                  <div className="signin-area mb-3.5 cursor-pointer" onClick={loginWithRedirect}>
                    {/* <div className="flex justify-center">
                      <button
                        type="button"
                        className="black-btn mb-6 text-sm text-white w-full h-[50px] font-semibold flex justify-center bg-purple items-center"

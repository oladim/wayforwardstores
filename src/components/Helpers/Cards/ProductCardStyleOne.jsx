  ...
  return (
    ...
    >
      ...
      <div className="product-card-details px-[30px] pb-[30px] relative">
        {/* add to card button */}
        <div className="absolute w-full h-10 px-[30px] left-0 top-40 group-hover:top-[60px] transition-all duration-300 ease-in-out">
          <button type="button" className="yellow-btn" onClick={() => addToCart(datas.id, 1, datas)}>
        ...
        <div className="reviews flex space-x-[1px] mb-3">
          {Array.from(Array(parseInt(datas.review)), () => (
      ...
      <div className="quick-access-btns flex flex-col space-y-2 absolute group-hover:right-4 -right-10 top-20  transition-all duration-300 ease-in-out">
        ...
        {/* <a href="#"> */}
        <span className="w-10 h-10 flex justify-center items-center bg-primarygray rounded cursor-pointer" onClick={() => addToWishList(datas.id, 1, datas)}>
          <ThinLove />
        </span>
        {/* </a> */}
        <a href="#">

...
export default function Banner({ className }) {
  ...
  const bannerItems = filter_products.filter((item) => item.banner === "yes");
          ...
          <div className="main-wrapper w-full">
            <div className="banner-card xl:flex xl:space-x-[30px] xl:h-[600px]  mb-[30px]">
              <div data-aos="fade-right" className="xl:w-[740px] w-full h-full">
                <a href={bannerItems.length > 0 ? `/single-product/${bannerItems["2"].id}` : "#"}>
                  <picture>
                    <source
                      media="(min-width:1025px)"
                      // srcSet={`${process.env.PUBLIC_URL}/assets/images/banner-1.png`}
                      // max-w-full h-auto object-fit
                      srcSet={bannerItems.length > 0 ? bannerItems["2"].url : "#"}
                      className="w-[740px] h-[600px]"
                    />
                    <img
                      src={bannerItems.length > 0 ? bannerItems["2"].url : "#"}
                      alt=""
              ...
              >
                <div className="w-full xl:h-1/2">
                  <a href={bannerItems.length > 0 ? `/single-product/${bannerItems["0"].id}` : "#"}>
                    <img
                      src={bannerItems.length > 0 ? bannerItems["0"].url : "#"}
                      alt=""
                      className="w-[398px] h-[285px]"
                    />
                  </a>
                </div>
                <div className="w-full xl:h-1/2">
                  <a href={bannerItems.length > 0 ? `/single-product/${bannerItems["1"].id}` : "#"}>
                    <img
                      src={bannerItems.length > 0 ? bannerItems["1"].url : "#"}
                      alt=""
                      className="w-[398px] h-[285px]"
                    />
                  </a>
